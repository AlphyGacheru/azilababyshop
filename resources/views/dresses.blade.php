                ...
                <div class="columns col-6 collection-item">
                    <div class="row">
                        <a>
                            ...
                            <div class="slider">
                                @foreach (json_decode($dress->filenames) as $picture)
                                    <div>
                            ...
                            <div class="t-shirt-button">
                                <div class="row" style="display: flex; text-align: center; ">
                                    <div class="columns col"><i class="fas fa fa-child"></i> {{ $dress->gender }}
                                    </div>
                                    <div class="columns col"><i class="fas fa fa-calendar"></i> {{ $dress->age }} Years
                                    </div>
                                ...
                                <div class="row" style=" text-align: center; ">
                                    <div class="columns col">T-shirt code: 0SX-{{ $dress->id }} </div>
