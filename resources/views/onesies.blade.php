...
@section('main-content')
    ...
    <section class="collections-section">
        ...
        <div class="row max-inner">
            @foreach ($onesies as $onesy)
                @auth
                    <form action="{{ route('onesies.destroy', $onesy->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                ...
                <div class="columns col-6 collection-item">
                    <div class="row">
                        <a>
                            ...
                            <div class="slider">
                                @foreach (json_decode($onesy->filenames) as $picture)
                                    <div>
                            ...
                            <div class="t-shirt-button">
                                <div class="row" style="display: flex; text-align: center; ">
                                    <div class="columns col"><i class="fas fa fa-child"></i> {{ $onesy->gender }}
                                    </div>
                                    <div class="columns col"><i class="fas fa fa-calendar"></i> {{ $onesy->age }} Years
                                    </div>
                                ...
                                <div class="row" style=" text-align: center; ">
                                    <div class="columns col">T-shirt code: 0NX-{{ $onesy->id }} </div>
