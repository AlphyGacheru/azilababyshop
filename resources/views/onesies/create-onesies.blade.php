...
@section('form')
    <h3>Create Onesies</h3>
    <br>
    <form role="form" action="{{ route('onesies.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row1">
            <div class="col-50">
                ...
                <input type="submit" value="Post Onesies To Website" class="btn">
            </div>
        </div>
    </form>
@endsection
