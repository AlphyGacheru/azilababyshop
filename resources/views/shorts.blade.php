    ...
    <section class="collections-section">
        ...
        <div class="row max-inner">
            @foreach ($shorts as $short)
                @auth
                    <form action="{{ route('shorts.destroy', $short->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                ...
                <div class="columns col-6 collection-item">
                    <div class="row">
                        <a>
                            ...
                            <div class="slider">
                                @foreach (json_decode($short->filenames) as $picture)
                                    <div>
                            ...
                            <div class="t-shirt-button">
                                <div class="row" style="display: flex; text-align: center; ">
                                    <div class="columns col"><i class="fas fa fa-child"></i> {{ $short->gender }}
                                    </div>
                                    <div class="columns col"><i class="fas fa fa-calendar"></i> {{ $short->age }} Years
                                    </div>
                                ...
                                <div class="row" style=" text-align: center; ">
                                    <div class="columns col">T-shirt code: 0TRX-{{ $short->id }} </div>
