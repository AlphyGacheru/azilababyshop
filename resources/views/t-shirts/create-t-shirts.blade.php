...
@section('form')
    <h3>Create T-shirts</h3>
    <br>
    <form role="form" action="{{ route('t-shirtsAdmin.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row1">
            <div class="col-50">
                ...
                <input type="submit" value="Post T-shirt To Website" class="btn">
            </div>
        </div>
    </form>
@endsection
