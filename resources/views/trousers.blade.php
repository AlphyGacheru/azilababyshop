    ...
    <section class="collections-section">
        ...
        <div class="row max-inner">
            @foreach ($trousers as $trouser)
                @auth
                    <form action="{{ route('trousers.destroy', $trouser->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                ...
                <div class="columns col-6 collection-item">
                    <div class="row">
                        <a>
                            ...
                            <div class="slider">
                                @foreach (json_decode($trouser->filenames) as $picture)
                                    <div>
                            ...
                            <div class="t-shirt-button">
                                <div class="row" style="display: flex; text-align: center; ">
                                    <div class="columns col"><i class="fas fa fa-child"></i> {{ $trouser->gender }}
                                    </div>
                                    <div class="columns col"><i class="fas fa fa-calendar"></i> {{ $trouser->age }} Years
                                    </div>
                                ...
                                <div class="row" style=" text-align: center; ">
                                    <div class="columns col">T-shirt code: 0TRX-{{ $trouser->id }} </div>
