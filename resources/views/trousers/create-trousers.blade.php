...
@section('form')
    <h3>Create Trousers</h3>
    <br>
    <form role="form" action="{{ route('trousers.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row1">
            <div class="col-50">
                ...
                <input type="submit" value="Post Trouser To Website" class="btn">
            </div>
        </div>
    </form>
@endsection
